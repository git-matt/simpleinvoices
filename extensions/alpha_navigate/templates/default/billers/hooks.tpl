{capture name="hook_billers_grid_top"}{strip}

{/strip}
	<div>
		<div class="si_filters_billers si_buttons_manage_billers">
...
<script type="text/javascript">{literal}
	...
	$('.qury').livequery('click', function(e){
		...
		} else
		{
			...
			$('#manageGrid').flexOptions({query: q, qtype: "abc", first: true, newp: 1, url: 'index.php?module={/literal}{$module}{literal}&view=xml2'}).flexReload();
			//$('.bDiv').css('opacity', '1');
		}
	});
</script>{/literal}
