...
{if $smarty.capture.hook_invoices_button_add ne ''}
	{$smarty.capture.hook_invoices_button_add}
{else}
...
{else}
	...
	<div class="si_filters_invoices si_buttons_manage_invoices">
		...
		<div class="si_toolbar si_toolbar_top si_toolbar_top_left">
		{if $smarty.capture.hook_invoices_filters}{$smarty.capture.hook_invoices_filters}{/if}
		</div>
	</div>

	<!--<div class="si_toolbar si_toolbar_top si_toolbar_top_left">-->
	{if $smarty.capture.hook_invoices_grid_top}{$smarty.capture.hook_invoices_grid_top}{/if}
	<!--</div>-->
	...
	{if $smarty.capture.hook_invoices_grid_end}{$smarty.capture.hook_invoices_grid_end}{/if}
{/if}
