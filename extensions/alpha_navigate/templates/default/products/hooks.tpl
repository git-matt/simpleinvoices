{capture name="hook_products_grid_top"}{strip}

{/strip}
	<div class="si_toolbar si_toolbar_top">
		<div class="si_filters_products si_buttons_manage_products">
...
<script type="text/javascript">{literal}
	...
	$('.qury').livequery('click', function(e){
		...
		} else
		{
			...
			$('#manageGrid').flexOptions({query: q, qtype: "abc", newp: 1, url: 'index.php?module=products&view=xml2'}).flexReload();
			//$('.bDiv').css('opacity', '1');
		}
	});
</script>{/literal}
