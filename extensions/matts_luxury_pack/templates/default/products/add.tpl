...
{if $defaults.inventory == '1'}
					<tr>
						<th>
							{$LANG.cost} <a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_cost" title="{$LANG.cost}"><img src="./images/common/help-small.png" alt="help-small" /></a>
						</th>
...
{html_options class=edit name=enabled options=$enabled selected=1}
			...
			<div id="section-2" class="fragment">
				...
				<table>
{if $customFieldLabel.product_cf1}
					<tr>
...
{/if}
{if $customFieldLabel.product_cf2}
					<tr>
...
{/if}
{if $customFieldLabel.product_cf3}
					<tr>
...
{/if}
{if $customFieldLabel.product_cf4}
					<tr>
...
{if $defaults.product_lwhw}
						<tr>
							<th>{$LANG.product_length|htmlsafe} 
								<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_product_length" title="{$LANG.product_length}"><img src="./images/common/help-small.png" alt="help-small" /></a>
							</th>
						...
						<tr>
							<th>{$LANG.product_width|htmlsafe} 
								<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_product_width" title="{$LANG.product_width}"><img src="./images/common/help-small.png" alt="help-small" /></a>
							</th>
						...
						<tr>
							<th>{$LANG.product_height|htmlsafe} 
								<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_product_height" title="{$LANG.product_height}"><img src="./images/common/help-small.png" alt="help-small" /></a>
							</th>
						...
						<tr>
							<th>{$LANG.product_weight|htmlsafe} 
								<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_product_weight" title="{$LANG.product_weight}"><img src="./images/common/help-small.png" alt="help-small" /></a>
							</th>
