{*
/*
* Script: extensions/matts_luxury_pack/templates/default/billers/details.tpl
* 	Details (view/edit) a Biller template
*
* Last edited by:
* 	git0matt@gmail.com
*/
*}
	...
	{if $smarty.capture.hook_billers_details_form_top}	{$smarty.capture.hook_billers_details_form_top}	{/if}
<form name="frmpost"
...
{if $smarty.get.action== 'view'}{**************************************}
	...
	{if $smarty.capture.hook_billers_details_hidden}	{$smarty.capture.hook_billers_details_hidden}	{/if}
	<div class="si_form si_form_view">
		<table>
	{if $smarty.capture.hook_billers_view_table_top}	{$smarty.capture.hook_billers_view_table_top}	{/if}
			<tr>
	...
	{if $smarty.capture.hook_billers_view_table_end}	{$smarty.capture.hook_billers_view_table_end}	{/if}
		</table>
	</div>
	<div class="si_toolbar si_toolbar_form">
	{if $smarty.capture.hook_billers_view_button_edit}
		{$smarty.capture.hook_billers_view_button_edit}
	{else}
...
{if $smarty.get.action== 'edit'}{**************************************}
	<div class="si_form">
		<table>
	{if $smarty.capture.hook_billers_edit_table_top}	{$smarty.capture.hook_billers_edit_table_top}	{/if}
			<tr>
				<th>{$LANG.biller_name}
		...
		{/if}
			...
			{* {showCustomFields categorieId="1" itemId=$smarty.get.id} *}
	{if $smarty.capture.hook_billers_edit_table_end}	{$smarty.capture.hook_billers_edit_table_end}	{/if}
		</table>
		<div class="si_toolbar si_toolbar_form">
	{if $smarty.capture.hook_billers_edit_submit}
		{$smarty.capture.hook_billers_edit_submit}
	{else}
	...
	{/if}
	{if $smarty.capture.hook_billers_edit_table_top}
		{$smarty.capture.hook_billers_edit_cancel}
	{else}
