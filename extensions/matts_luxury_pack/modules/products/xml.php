...
/*	if ($row['enabled']==$LANG['enabled']) {
	...
	if ($row['enabled']==$LANG['enabled']){
		$xml .= "<cell name='enabled'><![CDATA[
				<a id='enabled-".$row['id']."' data-id='$row[id]' title='$row[enabled]' class='makepdisabled'><img src='images/common/tick.png' alt='tick' /></a>
			]]></cell>";
	} else {
		$xml .= "<cell name='enabled'><![CDATA[
				<a id='disabled-".$row['id']."' data-id='$row[id]' title='$row[enabled]' class='makepenabled'><img src='images/common/cross.png' alt='cross' /></a>
			]]></cell>";
	}
	$xml .= "</row>";		
}
